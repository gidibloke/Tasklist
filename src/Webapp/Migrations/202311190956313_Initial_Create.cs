namespace Webapp.Migrations
{
    ...
    public partial class Initial_Create : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        AssigningUserId = c.String(maxLength: 128),
                        AssignedToUserId = c.String(maxLength: 128),
                        DateAssigned = c.DateTime(),
                        CompletedYN = c.Boolean(nullable: false),
                        DateCompleted = c.DateTime(),
                        HighPriority = c.Boolean(),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.AspNetUsers", t => t.AssignedToUserId)
                .ForeignKey("dbo.AspNetUsers", t => t.AssigningUserId)
        ...
        {
            DropForeignKey("dbo.Tasks", "AssigningUserId", "dbo.AspNetUsers");
            ...
            DropIndex("dbo.Tasks", new[] { "AssigningUserId" });
